...
### Data frames -----
##  A data frame is a named list with a number of constraints: 
##  can only hold same-length vectors or factors
...
# 使用索引值增加数据框的行数据
weather.new[c("7", "8"),] <- c("Friday", "Saturday", "Jul 10", "Jul 11", 90, 95, 32, 34)
weather.new
